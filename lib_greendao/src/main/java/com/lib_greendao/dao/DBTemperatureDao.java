...
/** 
 * DAO for table "DBTEMPERATURE".
*/
public class DBTemperatureDao extends AbstractDao<DBTemperature, Long> {

    public static final String TABLENAME = "DBTEMPERATURE";
    ...
    public DBTemperatureDao(DaoConfig config) {
        super(config);
    }
    
    public DBTemperatureDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DBTEMPERATURE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DBTEMPERATURE\"";
        db.execSQL(sql);
    }
