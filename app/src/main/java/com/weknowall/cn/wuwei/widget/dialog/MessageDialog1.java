...
public class MessageDialog1 extends Dialog {
    ...
    public MessageDialog1(@NonNull Context context) {
        super(context,R.style.CustomDialog);
    }

    public MessageDialog1(@NonNull Context context, @StyleRes int themeResId) {
    ...
    private void initEvent() {
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mYesListener != null) {
                    mYesListener.onClick(MessageDialog1.this, 0);
                }
                dismiss();
            }
        });
        ...
        no.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mNoListener != null) {
                    mNoListener.onClick(MessageDialog1.this, 0);
                }
                dismiss();
            }
        });
    ...
    public MessageDialog1 setPositiveButton(String yesText, AlertDialog.OnClickListener listener) {
        mYesText = yesText;
        mYesListener = listener;
        return this;
    }

    public MessageDialog1 setNegativeButton(String noText, AlertDialog.OnClickListener listener) {
        mNoText = noText;
        mNoListener = listener;
        return this;
    }

    public MessageDialog1 setTitle(String title) {
        mTitle = title;
        return this;
    }

    public MessageDialog1 setMessage(String message) {
        mMessage = message;
        return this;
    }

    public MessageDialog1 isSingle(boolean isSingle) {
        mIsSingle = isSingle;
        return this;
    }

    public MessageDialog1 isShowButton(boolean isShowButton){
     ...
     * @return
     */
    public MessageDialog1 setCanCancel(boolean canCancle) {
